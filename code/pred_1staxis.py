...
# Script for predicting the sagittal images for testing cases.
...
for line in FILE:
    ...
    image[:,0:155,0]=image1
    image[:,0:155,1]=image2
    image[:,0:155,2]=image3
    image[:,0:155,3]=image4
